...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { geofence: @administrator.geofence, last_access: @administrator.last_access, superadmin: @administrator.superadmin, user: @administrator.user } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { geofence: @administrator.geofence, last_access: @administrator.last_access, superadmin: @administrator.superadmin, user: @administrator.user } }
