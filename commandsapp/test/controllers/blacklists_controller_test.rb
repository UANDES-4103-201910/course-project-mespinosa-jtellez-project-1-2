...
class BlacklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blacklist" do
    assert_difference('Blacklist.count') do
      post blacklists_url, params: { blacklist: { date: @blacklist.date, user: @blacklist.user } }
    end
  ...
  test "should update blacklist" do
    patch blacklist_url(@blacklist), params: { blacklist: { date: @blacklist.date, user: @blacklist.user } }
