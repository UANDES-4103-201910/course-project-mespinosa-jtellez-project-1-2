...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { comment: @flag.comment, post: @flag.post, user: @flag.user } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { comment: @flag.comment, post: @flag.post, user: @flag.user } }
