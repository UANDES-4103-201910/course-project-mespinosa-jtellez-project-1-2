...
class AdministratorsTest < ApplicationSystemTestCase
  ...
  test "creating a Administrator" do
    ...
    fill_in "Geofence", with: @administrator.geofence
    fill_in "Last access", with: @administrator.last_access
    check "Superadmin" if @administrator.superadmin
    fill_in "User", with: @administrator.user
